...
const permissionsList: Permission[] = [
    ...
    { id: "25", name: "Доступ к разделу Хостинги", description: "Возможность просматривать раздел Хостинги", category: "Хостинги" },
    { id: "26", name: "Редактирование хостингов", description: "Возможность редактировать хостинг(и)", category: "Хостинги" },
    { id: "27", name: "Удаление хостингов", description: "Возможность удалять хостинг(и)", category: "Хостинги" },
    { id: "28", name: "Добавление хостингов", description: "Возможность добавлять хостинг(и)", category: "Хостинги" },

    { id: "29", name: "Просмотр серверов", description: "Возможность просматривать сервер(ы)", category: "Хостинги" },
    { id: "30", name: "Создание серверов", description: "Возможность добавлять сервер(ы)", category: "Хостинги" },
    { id: "31", name: "Обновление серверов", description: "Возможность редактировать сервер(ы)", category: "Хостинги" },
    { id: "32", name: "Удаление серверов", description: "Возможность удалять сервер(ы)", category: "Хостинги" },
];
